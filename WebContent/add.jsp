...
<jsp:include page="cabecalho.jsp">
	<jsp:param value="Adicionar candidato a usuário" name="titulo"/>
</jsp:include>
<c:if test="${not empty listaCandidatos}">
	<form name="candidato" id="contactForm" action="add" method="post">
       ...
       <div class="row control-group">	      
	           <div class="form-group col-xs-12 floating-label-form-group controls">
	              ...
	              <option value="Selecione o candidato">Selecione o candidato</option>
		      		  <c:forEach var="lc" items="${listaCandidatos}">
       ...
       <div class="row control-group">
           <div class="form-group col-xs-12 floating-label-form-group controls">
               ...
               <option value="Selecione o usuário">Selecione o usuário</option>
	      		  <c:forEach var="lu" items="${listaUsuario}">
       ...
       <div class="row">
           <div class="form-group col-xs-12">
               ...
               <a href="add?acao=vereditar" class="btn btn-default btn-lg">Editar vínculo</a>&nbsp;
        ...
        <c:if test="${empty listaCandidatos}">
